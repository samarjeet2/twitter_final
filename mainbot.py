...
while True:
    user = api.get_user('@Samarje10501741')
    api.update_profile(name=f'Samarjeet|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : Samarjeet|{follower_count(user)} Followers')
